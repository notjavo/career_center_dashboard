...
if topic == 'Career Center Student Engagement':
    subtopic_1= st.selectbox("Which Metric do you want to see?", ["Fairs Attendence", "Alignment", "Applications", "Career Readiness"])
    ...
    visual = handshake_data.groupby([subtopic_2, 'Number of Intenrships'])[subtopic_1].agg(['mean', 'median', 'std', 'min', 'max', 
                                                                            'count'])
    st.write(visual)
