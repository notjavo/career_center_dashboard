...
if topic == 'Career Center Student Engagement':
    ...
    if subtopic_2:
        visual = handshake_data[handshake_data['College_fds_2024'].isin(subtopic_2[0])].groupby([ 'College_fds_2024', 'Number of Internships',])[subtopic_1] \
                                                                    .agg(['mean', 'median', 'std', 'min', 'max','count'])
        visual = handshake_data[handshake_data['College_fds_2024'].isin(subtopic_2[1])].groupby([ 'College_fds_2024', 'Number of Internships',])[subtopic_1] \
                                                            .agg(['mean', 'median', 'std', 'min', 'max','count'])
